...
# This program works well with openCV3.0, so we will first check the openCV versions
print("OpenCv Version: {}".format(cv2.__version__))
SleepMode = input("Do you want to turn on Sleep mode? (Y/N) ")
...
while True:
    ...
    # Increase the frame count for grabbed frame
